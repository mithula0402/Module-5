...
## Result
The program successfully demonstrates a destructor in Python, where the constructor initializes the object and the destructor is called automatically when the object is deletedt
